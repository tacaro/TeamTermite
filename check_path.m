...
function [path_array, leave, x_stop, y_stop] = check_path(landscape, path_array, crossing_array, max_grass, stop_food, boundary)
...
for square = 2:num_squares
    ...
    if (xx + boundary) > size(landscape, 2) || ...
        ...
        break
    %Stop?
    elseif landscape(yy, xx, 1) .* landscape(yy, xx, 1) / max_grass > stop_food %Make this connect to parameters from top of run_and_tumble
